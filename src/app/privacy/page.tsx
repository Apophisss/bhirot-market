  ...
  return (
    <article className="mx-auto max-w-3xl space-y-5 sm:space-y-6">
      ...
      <LegalSection title="עוגיות">
        ...
        <p>
          ב־<code className="rounded bg-surface-2 px-1">localStorage</code> שבדפדפן שלכם נשמרים רק דברים ששייכים למכשיר הזה, או למי שאין לו חשבון:
          דחיית ההצעה להוסיף את האתר למסך הבית, ותשובות ודילוגים שנתתם <strong>לפני</strong> שהתחברתם — שנכנסים לחשבון אחרי שמתחברים.
          מרגע שאתם מחוברים, ההעדפות שבחרתם ורשימת השאלות שדילגתם עליהן נשמרות בחשבון — כדי שהאתר ייראה אותו דבר בכל מכשיר,
          ושמצב זריז לא יגיש לכם שוב שאלה שדילגתם עליה.
        </p>
      </LegalSection>
