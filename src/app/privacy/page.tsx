  ...
  return (
    <article className="mx-auto max-w-3xl space-y-5 sm:space-y-6">
      ...
      <LegalSection title="עוגיות">
        ...
        <p>
          העדפות תצוגה מקומיות (כמו מספר הנקודות שבחרתם לכל תשובה ב״מצב זריז״, ורשימת השאלות שדילגתם עליהן) נשמרות
          ב־<code className="rounded bg-surface-2 px-1">localStorage</code> בדפדפן שלכם ולא נשלחות אלינו כלל. היוצא מן הכלל
          אחד: אם אתם מחוברים, גם אנחנו שומרים על אילו שאלות דילגתם — רק כדי שמצב זריז לא יגיש לכם שוב את אותה שאלה.
        </p>
      </LegalSection>
