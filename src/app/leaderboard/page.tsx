...
const LEADERBOARD_DESCRIPTION =
  "מי הכי טוב בניחוש הבחירות? הדירוג האנונימי של בחירות מרקט לפי ניקוד כולל — נקודות פנויות בתוספת מה שיתקבל על התשובות הפתוחות אם יימכרו עכשיו. בלי שמות, בלי תמונות.";
    ...
    <div className="mx-auto max-w-3xl space-y-4">
      <div>
        ...
        <p className="text-[13px] text-muted sm:text-sm">
          דירוג לפי ניקוד כולל (נקודות פנויות + מה שיתקבל על התשובות הפתוחות במכירה עכשיו). כולם התחילו עם 10,000 נקודות; בונוס ההזמנות נספר
      ...
      {provisional && (
        <p className="rounded-xl border border-warn/40 bg-warn/10 px-3 py-2 text-[13px] leading-relaxed text-text">
          <strong>טרם הוכרעו שאלות · הדירוג זמני.</strong> כל רווח בלוח הוא כרגע שערוך של תשובות פתוחות ולא רווח סופי, ובשאלה שכמעט לא
          נענתה תשובה בודדת מזיזה את השערוך בעשרות נקודות. ברגע שיוכרעו שאלות ראשונות יופיע כאן גם דיוק ההכרעות — אחוז הפעמים שבהן צדקתם.
        </p>
      )}
          ...
          <table className="w-full table-fixed text-sm sm:table-auto">
            <thead className="bg-surface-2 text-xs text-muted">
              <tr>
                ...
                <th className="px-2 py-2 text-right font-medium sm:px-3" title={provisional ? "שערוך של תשובות פתוחות — אף שאלה לא הוכרעה עדיין" : undefined}>
                  {provisional ? "שערוך" : "רווח/הפסד"}
                </th>
                <th className="hidden px-3 py-2 text-right font-medium sm:table-cell">תשובות</th>
              </tr>
            </thead>
