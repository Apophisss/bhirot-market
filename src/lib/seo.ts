...
export const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "כל משתמש/ת שמתחבר/ת עם חשבון Google מקבל/ת ₪10,000 וירטואליים. לוח המובילים מדרג לפי שווי כולל — היתרה בתוספת שווי הפוזיציות הפתוחות במחירי השוק — והוא אנונימי: כל סוחר/ת מופיע/ה בכינוי אקראי, בלי שם ובלי תמונה.",
  },
  {
    q: "מי כותב את השאלות?",
