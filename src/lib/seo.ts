...
export const FAQ: { q: string; a: string }[] = [
  ...
  {
    q: "מי כותב את השאלות ובאיזו תדירות?",
    a: `${SITE_TEAM} של ${SITE_NAME} עובר על החדשות הפוליטיות בישראל פעם בשעה, מוסיף שאלות חדשות עם מועד יעד וקריטריוני הכרעה מפורשים, ומכריע שווקים שהאירוע שלהם כבר קרה. כל שאלה שנוספה אחרי ההשקה נושאת את הקרדיט של ${SITE_TEAM}.`,
  },
  {
    q: "איך שוק מוכרע?",
